...
export class Graph<T> {
  ...
  depthFirstSearch(startNode?: Node<T>) {
    const visited: Map<T, boolean> = new Map();

    if (startNode) {
      this.breadthFirstSearchAux(startNode, visited);
    }
  ...
  // Add array of required nodes (not all of them)
  breadthFirstSearch(startNode?: Node<T>) {
    const visited: Map<T, boolean> = new Map();
